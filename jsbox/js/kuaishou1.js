...
$ui.render({
  ...
  views: [{
    ...
    },
    {
      ...
      props: {
        id: "web",
        html: `<head><meta charset="UTF-8"></head><body><span style="font-size:34px;"><br><h1>使用说明：</h1><h2>在快手客户端复制你要下载的视频链接，粘贴到上面并按下获取按钮。<br>首次运行会自动识别并提取无水印视频</h2><br><h1><a href="http://t.cn/RrLlW7b">点击观看</a> 视频教程</h1> <br><h1><a href="https://iphone8.vip/fuli/xiaoliang.html">点击领取</a> 支付宝红包</h1><br><br><br><br><h2>by：iPhone 8、小良&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://iphone8.vip/">https://iphone8.vip/</a> </h2></span></body>`
      },
      layout: function(make) {
  ...
  $ui.push({
    ...
    views: [{
      ...
      },
      {
        ...
        props: {
          id: "bt1",
          src: "https://iphone8.vip/jsbox/img/gengduo.png",
          font: $font(20)
        },
        layout: function(make) {
          make.right.inset(10)
