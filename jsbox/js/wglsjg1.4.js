        ...
        views: [{
            ...
            props: {
                ...
                script: function () {
                    ...
                    document.getElementsByClassName("insert-app-download-fixed")[0].style.display = "none";
                    document.getElementsByClassName("app-download-look-more gotolink")[0].style.display = "none";
                    $notify("share")
...
function tmenu(text) {
    ...
    if (!url[0]) {
        ...
        $ui.toast("处理中，请稍后···")
        $('web').url = "https://tool.manmanbuy.com/m/history.aspx?url=" + $text.URLEncode(url);
        GetUrlParam(url[0])
...
function zhur() {
    var webView = $("web")
    webView.eval({
        script: `document.getElementsByClassName("clearfix dicountInfo")[0].style.display = "none";document.getElementsByClassName("culist")[0].style.display = "none";`,
